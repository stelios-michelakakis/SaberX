...
const ICONS: Record<string, string> = {
  ...
  trace:
    "M3 3.5h3v3h-3z M10 3.5h3v3h-3z M3 9.5h3v3h-3z M10 9.5h3v3h-3z M6 5h4 M11.5 6.5v3 M4.5 6.5v3 M6 11h4",
  ...
  users:
    "M5.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z M2 13.5c.3-2 2-3.5 3.5-3.5s3.2 1.5 3.5 3.5 M11 8.5a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z M14 13c-.2-1.6-1.4-2.7-2.5-2.8",
  settings:
    "M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z M13 8a5 5 0 0 0-.1-.9l1.4-1-1.4-2.4-1.7.5a4.9 4.9 0 0 0-1.5-.9L9.5 1.5h-3l-.2 1.8a4.9 4.9 0 0 0-1.5.9L3 3.7 1.7 6.1l1.4 1A5 5 0 0 0 3 8c0 .3 0 .6.1.9l-1.4 1 1.3 2.4 1.7-.5c.5.4 1 .7 1.5.9l.3 1.8h3l.2-1.8c.5-.2 1-.5 1.5-.9l1.7.5 1.4-2.4-1.4-1c0-.3.1-.6.1-.9Z",
  ...
  undo: "M5 5 2 8 5 11 M2 8h6a3 3 0 0 1 3 3v1.5",
  command:
    "M5.5 5.5h5v5h-5z M5.5 5.5V3.5a1.5 1.5 0 1 0-1.5 1.5h1.5 M10.5 5.5h2a1.5 1.5 0 1 0-1.5-1.5v1.5 M10.5 10.5h2a1.5 1.5 0 1 1-1.5 1.5v-1.5 M5.5 10.5v2a1.5 1.5 0 1 1-1.5-1.5h1.5",
...
export function Icon({
  ...
  const d = ICONS[name];
  if (!d) return null;
  const sizeClass = size === 12 ? " ic-sm" : size === 16 ? " ic-lg" : "";
  const cls = "ic" + sizeClass + (className ? " " + className : "");
  const customSize = size !== 12 && size !== 14 && size !== 16;
  const finalStyle: CSSProperties = customSize ? { width: size, height: size, ...style } : style ?? {};
  return (
    <svg viewBox="0 0 16 16" className={cls} style={finalStyle}>
      {d.split(" M").map((seg, i) => (
